...
import LeftSide from '../../shared/headerDefault/LeftSide';
import RightSide from '../../shared/headerDefault/RightSide';
import BurgerMenu from '../../shared/headerDefault/BurgerMenu';

const HeaderDefault = ({ active, handleBurgerClick,}) => {
        ...
        <header className={active && isFullWidth ? 'header-default header-default_active' : 'header-default'}>
            <nav className='header-default__container'>
                <div className={active ? 'header-default__nav header-default__nav_active' : 'header-default__nav'}>
                    ...
                    <RightSide isFullWidth={isFullWidth} active={active}/>
                </div>
