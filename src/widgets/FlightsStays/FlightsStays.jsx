...
const FlightsStays = () => {
  ...
  return (
    <div className="main-flights-stays">
      ...
      {flights ? (
        <FlightsForm promocode={promocode} />
      ) : (
        <StaysForm promocode={promocode} />
      )}
      ...
      <div className="main-flights-stays-options">
        ...
        >
          <IoAddOutline />
          <span className="main-flights-stays-promocode-text">
            Add Promo Code
          </span>
        </button>
        <Link to="https://t.me/whyME_3" className="main-flights-stays-show">
          <FaTelegramPlane />
