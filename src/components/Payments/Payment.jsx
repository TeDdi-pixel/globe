            ...
            <div className='personal-acc__payments-info' style={{justifyContent: (creditCards.length < 2 && !isFullWidth) ? 'flex-start' : 'space-evenly'}}>
                {
                    creditCards ?
                        user.creditCards.map((item, index) => {
                                ...
                                <>
                                    <li>
                                        ...
                                        <span className='personal-acc__payments-card-number-trash'>
                                            <svg  onClick={() => handleDeleteCard(index)} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            return (
                                <div key={index} htmlFor="card" className='personal-acc__payments-card'>
                                    <div className='personal-acc__payments-card-number__wrapper'>{maskedCardNumber}</div>
