...
const PersonalAccountMain = () => {
    const [isPhotoLoaded, setIsPhotoLoaded] = useState(!!Cookies.get('user').photo);
    console.log(isPhotoLoaded);
    return (
        <>
                ...
                <div className="personal-acc__container">
                    ...
                    <div className='personal-acc__profile-data'>
                        <div className='personal-acc__photo'>
                            ...
                            {isPhotoLoaded ?
                                <img src="./assets/img/13dc5b2e20dc60002c5ebc10bec549e3.jpg" alt="" /> :
                                <svg
